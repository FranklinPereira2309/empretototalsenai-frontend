...
function visualizarVagaSelecionada() {
    ...
    const url = `https://empretototalsenai.netlify.app/vaga/${idVaga}`;
    const token = localStorage.getItem('token');
...
function salvarEditarVaga() {
    ...
    const url = `https://empretototalsenai.netlify.app/vagas/${idVaga}`;
...
function toggleAtivarCurriculo() {
    ...
    let intervalo = setInterval(() => {
        ...
        if (window.confirm('Confirma a Ação para o  Curriculo Atual?')) {
            ...
            const url = `https://empretototalsenai.netlify.app/curriculo/${localStorage.getItem('idCurriculoAlterarSelecionado')}`;
...
function deletarCurriculoSelecionado() {
    ...
    let intervalo = setInterval(() => {
        ...
        if (window.confirm('Deletar Definitivamente o Curriculo Atual?')) {
            ...
            const url = `https://empretototalsenai.netlify.app/curriculo_selecionado/${curriculo_id}`;
...
function selecionarCurriculo() {
    ...
    let intervalo = setInterval(() => {
        ...
        if (window.confirm('Confirma a Ação para o  Curriculo Atual?')) {
            ...
            const url = `https://empretototalsenai.netlify.app/curriculo_selecionado`;
            const token = localStorage.getItem('token');
...
function visualizarCurriculoTipoParams() {
    ...
    const url = `https://empretototalsenai.netlify.app/curriculos_tipo_params/${tipo}`;
...
function consultarTodosCurriculosSelecionados() {
    const url = `https://empretototalsenai.netlify.app/curriculos_geral_selecionados`;
    const token = localStorage.getItem('token');
...
function visualizarTodosUsuariosCurriculos() {
    ...
    document.querySelector('.filters').style.display = 'none';
    const url = `https://empretototalsenai.netlify.app/vagas_usuarios_curriculos`;
